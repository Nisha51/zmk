...
static void uart_rx_main(void) {
    for (;;) {
        ...
        uint8_t claim_len = ring_buf_put_claim(ring_buf, &buf, 1);
...
K_THREAD_DEFINE(uart_transport_read_thread, CONFIG_ZMK_STUDIO_TRANSPORT_UART_RX_STACK_SIZE, uart_rx_main, NULL, NULL,
